...
public class Menu extends JPanel {
    ...
    private final String headerName = "Sri Weerasinghe Piriwena";

    protected final boolean hideMenuTitleOnMinimum = true;
    protected final int menuTitleLeftInset = 5;
    protected final int menuTitleVgap = 5;
    protected final int menuMaxWidth = 290;
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("/raven/icon/png/Chakra1.png")));
